 ...
 */
public class HVScaleScrollView extends FrameLayout {
    ...
    public HVScaleScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initScrollView();
        initGesture(context);
    }
...
//            Log.e(TAG, "onScaleBegin: " + scaleDuration);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        boolean event = mScaleGestureDetector.onTouchEvent(ev);
